...
Once the logs are processed by learn mode policy builder tools, following policy related commands can be run to list the existing policies or show updates recommended by the tool.
...
List the policies with lean mode updates:
